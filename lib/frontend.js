...
class Frontend
{
    ...
    async generateTemplateContent(templatePath, domain)
    {
        ...
        return await this.templateEngine.render(template, {}, this.getPartialsForDomain(domain), domain);
    }
    ...
    {
        return res.send(await this.renderWithTemplateContent(content, data, domain));
    }
    ...
    async renderContentWithTemplate(templatePath, data, domain)
    {
        ...
        return await this.templateEngine.render(template, data, this.getPartialsForDomain(domain), domain);
    }
    ...
    async processContent(content, data, domain)
    {
        ...
        return await this.templateEngine.render(contentText, data, this.getPartialsForDomain(domain), domain);
    }

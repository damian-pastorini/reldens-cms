...
class TemplateEngine
{
    ...
    async render(template, data, partials, domain)
    {
        ...
        return this.renderEngine.render(
            this.unescapeHtml(await this.processAllTemplateFunctions(template, domain)),
            data,
            partials
        );
    }
    ...
    async processEntityFunctions(template, domain)
    {
    ...
    async processSingleFieldCollections(template, domain)
    {
        let processedTemplate = template;
    ...
    async processLoopCollections(template, domain)
    {
        let processedTemplate = template;
    ...
    async processCustomPartials(template, domain)
    {
        let processedTemplate = template;

...
class AdminManager
{
    ...
    constructor(configData)
    {
        ...
        this.router = new Router({
            ...
            secret: this.secret,
            sessionCookieSecure: sc.get(configData?.appServerFactory, 'useHttps', false),
            sessionCookieSameSite: sc.get(configData, 'sessionCookieSameSite', 'lax'),
            sessionCookieMaxAge: sc.get(configData, 'sessionCookieMaxAge', 0),
            sessionRolling: sc.get(configData, 'sessionRolling', false),
            sessionStore: sc.get(configData, 'sessionStore', false),
            trustedProxy: sc.get(configData?.appServerFactory, 'trustedProxy', ''),
            csrfEnabled: sc.get(configData, 'csrfEnabled', false),
            csrfIgnoredPaths: sc.get(configData, 'csrfIgnoredPaths', []),
            rootPath: this.rootPath,
